...
import com.optimalsystems.AdminChurch.activities.PostDetailActivity;
import com.optimalsystems.AdminChurch.models.Like;
        ...
        mLikesProvider.getLikeByPostAndUser(like.getIdPost(), mAuthProvider.getUid()).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                if (numberDocuments > 0) {
                    ...
                    holder.imageViewLike.setImageResource(R.drawable.icons_inactivo);
                    mLikesProvider.delete(idLike);
                }
                else {
                    holder.imageViewLike.setImageResource(R.drawable.icons_activo);
