...
import com.optimalsystems.AdminChurch.providers.ImageProvider;
import com.optimalsystems.AdminChurch.providers.UsersProvider;
import com.optimalsystems.AdminChurch.utils.FileUtil;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(EditProfileActivity.this, "com.optimalsystems.AdminChurch", photoFile);
